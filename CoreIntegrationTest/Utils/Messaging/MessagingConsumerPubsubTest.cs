...
public class MessagingConsumerPubsubTest
{
    ...
    public async Task ConsumerReceiveMessage()
    {
        ...
        var consumerPubsub = new MessagingConsumerPubsub(logger.Object,options.Object, metrics.Object, vault.Object);
        ...
        consumerPubsub.OnReceiveMessage +=  (_, message) =>
        {
            resultMessage = message;
            consumerPubsub.StopListening();
